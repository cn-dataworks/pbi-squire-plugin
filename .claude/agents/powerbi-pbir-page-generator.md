...
2. **JSON Schema**: Valid Power BI visual.json and page.json structures
3. **Config Blobs**: Stringified JSON configuration for visual formatting
4. **Measure Bindings**: Query transform syntax for measure references
