#!/usr/bin/env bash
#
# Power BI Analyst Skill - Installer (Bash)
#
...
show_install_summary() {
    ...
    echo -e "\033[36m Power BI Analyst Skill - Installation Complete\033[0m"
    echo -e "\033[36m============================================================\033[0m"
...
main() {
    echo ""
    echo -e "\033[36mPower BI Analyst Skill Installer\033[0m"
