# PBI Squire - Pro Features

This document contains Pro-tier features for the PBI Squire skill.
...
### Tools
- `tools/developer/monitor_deployment_status.py` - GitHub Actions monitor
