...
1. **Start Monitoring**
   ```
      └─ 🔧 [BASH] python tools/developer/monitor_deployment_status.py --repo "<repo>" --commit "<sha>" --workflow "<workflow>" --timeout <seconds>
   ```
...
- `tools/developer/monitor_deployment_status.py` - Deployment monitor
