...
<#
.SYNOPSIS
    PBI Squire Skill - Installer (PowerShell)
...
function Show-InstallSummary {
    ...
    Write-Host " PBI Squire Skill - Installation Complete" -ForegroundColor Cyan
...
try {
    Write-Host "`n"
    Write-Host "PBI Squire Skill Installer" -ForegroundColor Cyan
