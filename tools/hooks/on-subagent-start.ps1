...
.DESCRIPTION
    This script is invoked by Claude Code when a powerbi-* subagent starts.
    It can be used to:
    - Initialize logging
...
.PARAMETER AgentName
    The name of the subagent that started (e.g., powerbi-code-locator)

.EXAMPLE
    .\on-subagent-start.ps1 powerbi-code-locator
#>
